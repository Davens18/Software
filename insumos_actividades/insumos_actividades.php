...
<div class="container mt-3 shadow">
    <div class="row">
        ...
        <div class="col ms-3">
            <form action="consulta_insumos_actividades.php" method="POST" class="bg-dark mx-0 p-2 rounded-2 shadow">
                <legend class="text-center text-danger">Ingrese Itém Actividad</legend>
                <div class="row">
                    <div class="col-8">
                        <label for="item" class="text-light ms-1">Itém</label>
                        <input type="text" class="form-control m-1" name="item_a" placeholder="Ingrese itém de la actividad">
                    </div>
                </div>
